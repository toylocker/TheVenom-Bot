let handler = m => m; 
 ...
 let responses; 
 if (/^شهد بحبك|شهد عاوزه اتجوزك|بحبك|بموت فيك|نتجوز|شهد هنتجوز امتي|شهد انت ليا|شهد بموت فيك$/i.test(m.text)) { 
 responses = [ 
 'شكرا  ',
   'ونا بكرهك',
 'هفكر في الموضوع',  
 ...
 'طيب و بعدين '  ,
   'ملللللللللللللللللللللللللللللللللللللللللللللللل'
 ]; 
 ...
 }else if (/^ زورو عامل ايه|عامله ايه|عاملين ايه|الدنيا عامله ايه|عاملين ايه يشبب$/i.test(m.text)) { 
 responses = [ 
